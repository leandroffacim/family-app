  ...
  return (
    ...
    >
      <Box sx={{ flex: 1, minWidth: 0 }}>
        <Typography noWrap sx={{ fontWeight: 700, fontSize: 15, color: "#0F172A" }}>
          {task.name}
        </Typography>
        <Stack direction="row" spacing={1} sx={{ mt: 0.75, alignItems: "center" }}>
          <Chip
            ...
            sx={{
              ...
              fontSize: 11,
              fontWeight: 700,
              bgcolor: task.freq === "DAILY" ? "#EEF2FF" : task.freq === "WEEKLY" ? "#FEF3C7" : "#F1F5F9",
              color: task.freq === "DAILY" ? "#4F46E5" : task.freq === "WEEKLY" ? "#D97706" : "#475569",
            }}
          />
      ...
      <Stack direction="row" spacing={1} sx={{ alignItems: "center", bgcolor: "#F8FAFC", px: 1.25, py: 0.5, borderRadius: 99, border: "1px solid #F1F5F9" }}>
        <Typography variant="caption" sx={{ fontSize: 11, fontWeight: 600, color: "#64748B" }}>
          Vez de:
        </Typography>
        <Avatar member={assignedMember} size={24} showBorder={false} />
        <Typography variant="body2" sx={{ fontSize: 12, fontWeight: 700, color: "#0F172A" }}>
